...
static gboolean phonon_mode_timeout(struct model_pak *model)
{
static gint count=0;
gdouble f;
gchar *name, *text;
...
static gboolean phonon_mode_timeout_cb(gpointer data)
{
return(phonon_mode_timeout(data));
}
...
g_timeout_add(100, phonon_mode_timeout_cb, model);
}
