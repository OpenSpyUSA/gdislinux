...
/* Names discovered via module_setup() already include the platform-specific
 * filename decoration, so just join them to the module directory. */
if (path && *path)
