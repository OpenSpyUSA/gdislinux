...
void gui_pulldown_set_text(gpointer, const gchar *);
GtkWidget *gui_combo_new(GList *, gint);
GtkWidget *gui_combo_entry(GtkWidget *);
const gchar *gui_combo_text(GtkWidget *);
void gui_combo_set_text(GtkWidget *, const gchar *);
