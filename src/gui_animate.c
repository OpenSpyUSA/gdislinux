...
static gboolean anim_next_frame(struct model_pak *model)
{
gulong time;
gchar *text, *name;
...
static gboolean anim_next_frame_cb(gpointer data)
{
return(anim_next_frame(data));
}
...
g_timeout_add(freq, anim_next_frame_cb, model);
